  ...
  if (loading) {
    return (
      <div className="glass-card h-full p-5 flex flex-col">
        <div className="h-3.5 w-28 rounded bg-zinc-100 dark:bg-zinc-900 skeleton-shimmer mb-4" />
  ...
  return (
    <div className="glass-card h-full p-4 sm:p-5 flex flex-col overflow-hidden">
      ...
      <button
        ...
        className="mt-3 w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-zinc-50 dark:bg-zinc-900 text-zinc-700 dark:text-zinc-300 text-[12px] font-medium hover:bg-zinc-100 dark:hover:bg-white/[0.07] hover:text-zinc-900 dark:hover:text-white transition-colors disabled:opacity-50 border border-zinc-200 dark:border-zinc-200 dark:border-zinc-800"
      >
...
function MiniStat({ icon: Icon, label, value }: { icon: any; label: string; value: string }) {
  return (
    <div className="rounded-lg border border-zinc-200 dark:border-zinc-200 dark:border-zinc-800 bg-zinc-50/60 dark:bg-zinc-950 px-2.5 py-2">
