  ...
  if (loading) {
    return (
      <div className="glass-card p-6 h-full flex flex-col">
        <div className="h-3.5 w-24 rounded bg-zinc-100 dark:bg-zinc-900 skeleton-shimmer mb-4" />
      ...
      <div className="glass-card p-6 h-full flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center">
          ...
          <button
            ...
            className="mt-4 text-[11px] font-medium px-4 py-2 rounded-lg bg-zinc-50 dark:bg-zinc-950 text-zinc-500 dark:text-zinc-400 hover:text-[#1ED4A7] transition-colors border border-zinc-200 dark:border-zinc-200 dark:border-zinc-800 hover:border-[#1ED4A7]/30"
          >
