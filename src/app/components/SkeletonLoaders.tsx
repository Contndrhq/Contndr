...
function Bone({ className = '' }: { className?: string }) {
  return (
    <div
      className={`rounded-lg bg-zinc-200 dark:bg-zinc-900 animate-pulse skeleton-shimmer ${className}`}
    />
  );
}
    ...
    <div className="h-full overflow-y-auto p-6 lg:p-8 space-y-8 view-enter">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div
            key={i}
            className="rounded-2xl border border-zinc-200 dark:border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-5 space-y-3"
          >
            <div className="flex items-center justify-between">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="rounded-2xl border border-zinc-200 dark:border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-6 space-y-4">
  ...
  return (
    <div className="h-full overflow-y-auto p-6 lg:p-8 space-y-6 view-enter">
      ...
      <div className="rounded-2xl border border-zinc-200 dark:border-zinc-200 dark:border-zinc-800 overflow-hidden">
        {/* Table header */}
        <div className="bg-zinc-50 dark:bg-zinc-950 px-6 py-3 flex items-center gap-4 border-b border-zinc-200 dark:border-zinc-200 dark:border-zinc-800">
    ...
    <div className="h-full overflow-y-auto p-6 lg:p-8 space-y-6 view-enter">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {Array.from({ length: 6 }).map((_, i) => (
          <div
            key={i}
            className="rounded-2xl border border-zinc-200 dark:border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-5 space-y-4"
          >
            <div className="flex items-center justify-between">
              <Bone className="h-5 w-32" />
              <Bone className="h-6 w-16 rounded-full" />
...
export const AnalyticsSkeleton = memo(function AnalyticsSkeleton() {
  return (
    <div className="h-full overflow-y-auto p-6 lg:p-8 space-y-8 view-enter">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="rounded-2xl border border-zinc-200 dark:border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-5 space-y-3">
            <Bone className="h-4 w-20" />
            <Bone className="h-8 w-24" />
          </div>
        ))}
...
export const AiCallsSkeleton = memo(function AiCallsSkeleton() {
  return (
    <div className="h-full overflow-y-auto p-6 lg:p-8 space-y-6 view-enter">
      ...
      {/* Live call banner */}
      <div className="rounded-2xl border border-zinc-200 dark:border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-5 flex items-center gap-4">
        <Bone className="h-12 w-12 rounded-full" />
        <div className="flex-1 space-y-2">
          <Bone className="h-5 w-48" />
          <Bone className="h-3 w-32" />
...
export const RevenueSkeleton = memo(function RevenueSkeleton() {
  return (
    <div className="h-full overflow-y-auto p-6 lg:p-8 space-y-8 view-enter">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {[0,1].map(i => (
          <div key={i} className="rounded-2xl border border-zinc-200 dark:border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-6 space-y-4">
            <Bone className="h-5 w-36" />
          ...
          {cols.map((count, ci) => (
            <div key={ci} className="w-64 flex flex-col gap-3">
              ...
              {Array.from({ length: count }).map((_, i) => (
                <div key={i} className="rounded-xl border border-zinc-200 dark:border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-4 space-y-3">
                  <Bone className="h-4 w-36" />
                  <Bone className="h-3 w-24" />
    ...
    <div className="h-full overflow-y-auto p-6 lg:p-8 space-y-6 view-enter">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="rounded-2xl border border-zinc-200 dark:border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-5 space-y-4">
            <div className="flex items-center gap-3">
