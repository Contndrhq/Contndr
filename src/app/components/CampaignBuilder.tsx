...
Email Goal: Schedule a consultation to discuss their digital needs. Include "See how it works → sourcr.net"`;
              ...
              className="w-full px-4 py-3 text-[14px] border border-zinc-200 dark:border-white/10 bg-white dark:bg-white/[0.03] text-zinc-900 dark:text-white rounded-xl focus:outline-none focus:border-zinc-900 dark:focus:border-white/30 focus:ring-1 focus:ring-zinc-900/10 dark:focus:ring-white/10 transition-all"
            >
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1.5">
                  {attachments.map(att => (
                    <div
                      key={att.id}
                      className="flex items-center gap-2.5 px-3 py-2.5 bg-zinc-50/80 dark:bg-white/[0.03] border border-zinc-200 dark:border-white/10 rounded-xl group"
                    >
          ...
          {!isAdmin && !signatureText && (campaign.senderName || campaign.fromEmail || campaign.landingUrl) && (
            <div className="p-4 rounded-xl bg-zinc-50/80 dark:bg-white/[0.02] border border-zinc-200 dark:border-white/10">
          ...
          <div className="space-y-4 border border-zinc-200 dark:border-white/10 rounded-xl p-4 bg-zinc-50/50 dark:bg-white/[0.01]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2.5 text-[13px] border border-zinc-200 dark:border-white/10 bg-white dark:bg-white/[0.03] text-zinc-900 dark:text-white rounded-xl focus:outline-none focus:border-zinc-900 dark:focus:border-white/30 focus:ring-1 focus:ring-zinc-900/10 dark:focus:ring-white/10 transition-all"
                >
                  {toneOptions.map(opt => (
          ...
          {/* Signature Preview */}
          {signatureText && (
            <div className="bg-zinc-50/80 dark:bg-white/[0.02] border border-zinc-200 dark:border-white/10 rounded-xl p-4">
              ...
              <div className="bg-white dark:bg-white/[0.03] border border-zinc-200 dark:border-white/10 rounded-lg px-4 py-3">
        ...
        <div className="space-y-5 flex-1 flex flex-col">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 text-[14px] border border-zinc-200 dark:border-white/10 bg-white dark:bg-white/[0.03] text-zinc-900 dark:text-white placeholder-zinc-400 dark:placeholder-zinc-600 rounded-xl focus:outline-none focus:border-zinc-900 dark:focus:border-white/30 focus:ring-1 focus:ring-zinc-900/10 dark:focus:ring-white/10 transition-all"
            />
          </div>
            ...
            <div className="space-y-3">
              ...
              {showFilters && (
                <div className="space-y-3">
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 p-4 bg-zinc-50/80 dark:bg-white/[0.02] border border-zinc-200 dark:border-white/10 rounded-xl relative">
                    {/* Industry Filter */}
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="w-full text-left px-3 py-2.5 text-[13px] border border-zinc-200 dark:border-white/10 bg-white dark:bg-white/[0.03] text-zinc-900 dark:text-white rounded-lg focus:outline-none focus:border-zinc-900 dark:focus:border-white/30 focus:ring-1 focus:ring-zinc-900/10 dark:focus:ring-white/10 transition-all flex items-center justify-between"
                      >
          ...
          <div className="sticky bottom-0 mt-auto -mx-4 sm:-mx-7 px-4 sm:px-7 pt-3 pb-4 sm:pb-7 bg-[var(--background)] border-t border-[var(--border)] z-10 -mb-4 sm:-mb-7 flex gap-3">
            <button
              ...
              className="px-5 py-3 text-[14px] font-medium border border-zinc-200 dark:border-white/10 text-zinc-700 dark:text-zinc-300 bg-white dark:bg-white/[0.03] rounded-xl hover:bg-zinc-50 dark:hover:bg-white/5 transition-all active:scale-[0.98] min-h-[44px]"
            >
        ...
        <div className="space-y-5 flex-1 flex flex-col">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 text-[14px] font-medium border border-zinc-200 dark:border-white/10 bg-white dark:bg-white/[0.03] text-zinc-900 dark:text-white rounded-xl focus:outline-none focus:border-zinc-900 dark:focus:border-white/30 focus:ring-1 focus:ring-zinc-900/10 dark:focus:ring-white/10 transition-all"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 text-[14px] border border-zinc-200 dark:border-white/10 bg-white dark:bg-white/[0.03] text-zinc-500 dark:text-zinc-400 rounded-xl focus:outline-none focus:border-zinc-900 dark:focus:border-white/30 focus:ring-1 focus:ring-zinc-900/10 dark:focus:ring-white/10 transition-all"
            />
          </div>
          ...
          <div>
            ...
            <div className="px-5 py-5 bg-white dark:bg-white/[0.02] border border-zinc-200 dark:border-white/10 rounded-xl shadow-sm">
              <div 
          ...
          <div className="flex flex-col gap-3 pt-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3 pt-3 border-t border-zinc-200 dark:border-white/10">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2.5 text-[13px] border border-zinc-200 dark:border-white/10 bg-white dark:bg-white/[0.03] text-zinc-900 dark:text-white rounded-lg focus:outline-none focus:border-zinc-900 dark:focus:border-white/30 focus:ring-1 focus:ring-zinc-900/10 dark:focus:ring-white/10 transition-all"
                    >
            ...
            <div className="sticky bottom-0 mt-auto -mx-4 sm:-mx-7 px-4 sm:px-7 pt-3 pb-4 sm:pb-7 bg-[var(--background)] border-t border-[var(--border)] z-10 -mb-4 sm:-mb-7 flex gap-3">
              <button
                onClick={() => setStep('leads')}
                className="px-5 py-3 text-[14px] font-medium border border-zinc-200 dark:border-white/10 text-zinc-700 dark:text-zinc-300 bg-white dark:bg-white/[0.03] rounded-xl hover:bg-zinc-50 dark:hover:bg-white/5 transition-all active:scale-[0.98]"
              >
                {t('campaignBuilder.back')}
              </button>
              <button
