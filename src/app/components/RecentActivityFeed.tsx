...
export function RecentActivityFeed({ onNavigate }: RecentActivityFeedProps) {
  ...
  return (
    <div className="glass-card p-4 h-full min-h-full flex flex-col overflow-hidden">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-x-4 gap-y-1 flex-1 min-h-0 content-start auto-rows-min items-start overflow-y-auto pr-1 custom-scrollbar">
