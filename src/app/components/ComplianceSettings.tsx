    ...
    <div className="space-y-6">
      ...
      {stats && (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="bg-zinc-50 dark:bg-white/[0.02] border border-zinc-200 dark:border-white/5 rounded-xl p-4">
        ...
        <div className="space-y-2">
          {filteredUnsubs.length === 0 ? (
            ...
            filteredUnsubs.map(email => (
              <div key={email} className="flex items-center justify-between px-4 py-2.5 bg-white dark:bg-white/[0.02] border border-zinc-200 dark:border-white/5 rounded-lg">
            ...
            <div>
              ...
              <div className="space-y-1">
                {filteredBlEmails.slice(0, 50).map(email => (
                  <div key={email} className="flex items-center justify-between px-3 py-2 bg-white dark:bg-white/[0.02] border border-zinc-200 dark:border-white/5 rounded-lg">
                    <span className="text-sm text-black dark:text-white font-mono">{email}</span>
            ...
            <div>
              ...
              <div className="space-y-1">
                {filteredBlDomains.slice(0, 50).map(domain => (
                  <div key={domain} className="flex items-center justify-between px-3 py-2 bg-white dark:bg-white/[0.02] border border-zinc-200 dark:border-white/5 rounded-lg">
