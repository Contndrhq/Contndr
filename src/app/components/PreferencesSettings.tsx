              ...
              <button
                ...
                className={`group relative rounded-2xl border-2 transition-all duration-200 overflow-hidden ${
                  active
                    ...
                    : 'border-zinc-200 dark:border-white/[0.08] hover:border-zinc-300 dark:hover:border-white/[0.15] hover:shadow-md'
                }`}
              >
                {/* Mini preview */}
                <div className={`h-[88px] relative overflow-hidden ${
                  ...
                  {opt.id !== 'system' ? (
                    <div className="absolute inset-2 flex gap-1.5">
                      {/* Sidebar */}
                      <div className={`w-[28%] rounded-lg ${opt.id === 'dark' ? 'bg-white/[0.06]' : 'bg-zinc-200/60'}`}>
                        <div className="p-1.5 space-y-1">
                          <div className={`h-1 w-[70%] rounded-full ${opt.id === 'dark' ? 'bg-white/10' : 'bg-zinc-300/80'}`} />
                          <div className={`h-1 w-[50%] rounded-full ${opt.id === 'dark' ? 'bg-white/[0.06]' : 'bg-zinc-200/80'}`} />
                          <div className={`h-1 w-[60%] rounded-full ${opt.id === 'dark' ? 'bg-white/[0.06]' : 'bg-zinc-200/80'}`} />
                          <div className={`h-1 w-[40%] rounded-full ${opt.id === 'dark' ? 'bg-white/[0.06]' : 'bg-zinc-200/80'}`} />
                        </div>
                      </div>
                      {/* Main content */}
                      <div className="flex-1 space-y-1.5 p-1">
                        ...
                        <div className="flex gap-1">
                          <div className={`h-3 flex-1 rounded ${opt.id === 'dark' ? 'bg-white/[0.04]' : 'bg-zinc-100/80'}`} />
                          <div className={`h-3 flex-1 rounded ${opt.id === 'dark' ? 'bg-white/[0.04]' : 'bg-zinc-100/80'}`} />
                        </div>
                      </div>
                    </div>
                    ...
                    <>
                      ...
                      <div className="absolute inset-y-2 right-2 left-[50%] ml-0.5 flex gap-1">
                        <div className="w-[30%] rounded-l-lg bg-white/[0.06]">
                          <div className="p-1 space-y-1">
                            <div className="h-1 w-[70%] rounded-full bg-white/10" />
                            <div className="h-1 w-[50%] rounded-full bg-white/[0.06]" />
                          </div>
                        </div>
                        <div className="flex-1 p-1 space-y-1">
                ...
                <div className={`px-3 py-2.5 flex items-center gap-2 transition-colors ${
                  active ? 'bg-zinc-50 dark:bg-white/[0.04]' : 'bg-white dark:bg-transparent'
                }`}>
      ...
      <div>
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center justify-between py-3.5 px-4 rounded-xl hover:bg-zinc-50 dark:hover:bg-white/[0.02] transition-colors group">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-zinc-100 dark:bg-white/[0.06] flex items-center justify-center group-hover:bg-zinc-200/60 dark:group-hover:bg-white/[0.08] transition-colors">
            ...
            <div className="flex bg-zinc-100 dark:bg-white/[0.06] rounded-lg p-0.5 border border-zinc-200/60 dark:border-white/[0.06]">
