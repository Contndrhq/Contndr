      ...
      {loading ? (
        ...
        <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar space-y-0.5 -mx-1">
          {signals.map((signal) => (
            ...
            >
              <div className="w-7 h-7 rounded-lg bg-zinc-100 dark:bg-zinc-900 flex items-center justify-center flex-shrink-0 group-hover:bg-zinc-200 dark:group-hover:bg-white/[0.08] transition-colors">
