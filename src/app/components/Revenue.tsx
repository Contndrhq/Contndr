        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="max-w-lg w-full text-center space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {/* Stripe card */}
              <div className="bg-white dark:bg-white/[0.03] border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 text-left space-y-4">
    ...
    <div className="flex flex-col h-full bg-transparent overflow-y-auto">
      <div className="px-4 sm:px-6 py-4 sm:py-6 space-y-6 animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-1">
              ...
              {isDemoAccount && <span className="ml-2 text-[10px] font-medium px-1.5 py-0.5 rounded-full bg-zinc-100 dark:bg-white/[0.06] text-zinc-500">Demo</span>}
            </p>
          </div>
        ...
        {!bothConnected && !isDemoAccount && (
          <div className="bg-white dark:bg-white/[0.02] border border-dashed border-zinc-300 dark:border-zinc-700 rounded-xl p-5 flex items-center gap-4">
