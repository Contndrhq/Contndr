  ...
  return (
    <div className="max-w-3xl space-y-8">
      ...
      <SettingsSection title="AI Call Sales Playbook (legacy)">
        ...
        {/* Close mechanics */}
        <div className="px-4 py-3 border-t border-zinc-100 dark:border-white/[0.06] grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className="px-4 py-3 border-t border-zinc-100 dark:border-white/[0.06] flex justify-end">
